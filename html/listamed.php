...
(!$connection) 
    ...
    $instruccion_SQL = "INSERT INTO medico(`nombre`, `apellido`, `especialidad`, `consultorio`, `correo`) 
...
echo "<th><h1>Especialidad</th>;
echo "<th><h1>Consultorio</th>;
...
echo "<td><h2>" . $colum['consultorio'] . "</td></h2>";
